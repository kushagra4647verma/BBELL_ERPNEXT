frappe.ui.form.on('Statement of Accounts', {
	...
	refresh: function(frm){
		if(!frm.doc.__islocal) {
			frm.add_custom_button('Send Emails',function(){
				frappe.call({
					method: "finbyzerp.finbyzerp.doctype.statement_of_accounts.statement_of_accounts.send_emails",
					args: {
			...
			frm.add_custom_button('Download',function(){
				...
				var url = frappe.urllib.get_full_url(
					'/api/method/finbyzerp.finbyzerp.doctype.statement_of_accounts.statement_of_accounts.download_statements?'
	...
	fetch_customers: function(frm){
		if(frm.doc.collection_name){
			frappe.call({
				method: "finbyzerp.finbyzerp.doctype.statement_of_accounts.statement_of_accounts.fetch_customers",
				args: {
...
frappe.ui.form.on('Statement of Accounts Party', {
	customer: function(frm, cdt, cdn){
		...
		frappe.call({
			method: 'finbyzerp.finbyzerp.doctype.statement_of_accounts.statement_of_accounts.get_customer_emails',
			args: {
				'type':'Customer',
